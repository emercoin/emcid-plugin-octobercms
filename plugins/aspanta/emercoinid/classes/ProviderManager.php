<?php namespace Aspanta\EmercoinID\Classes;
	...
	public function listProviders()
	{
		if ($this->providers === null) {
			...
			foreach ($plugins as $plugin) {
				...
				if ( !method_exists($plugin, 'register_aspanta_emercoinid_providers') )
					continue;

				// Plugin didn't register any menu item types
				if (!is_array($types = $plugin->register_aspanta_emercoinid_providers()))
					continue;
